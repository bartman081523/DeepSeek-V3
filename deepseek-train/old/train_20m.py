...
if __name__ == '__main__':
    ...
    if init_from == 'scratch':
        model_args = dict(
            ...
            qk_nope_head_dim=16,  # Keep at 16
            qk_rope_head_dim=16, # Keep at 16
            v_head_dim=16,       # keep at 16
            original_seq_len=4096,
            rope_theta=10000.0,
            rope_factor=1.0,
            beta_fast=32,
            beta_slow=1,
            mscale=1.0,
            dim=96,           # Reduced dimension. This is our primary tuning knob.
            inter_dim=384,    # 4 * dim
            moe_inter_dim=384,  # Match inter_dim
