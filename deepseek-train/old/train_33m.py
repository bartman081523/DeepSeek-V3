...
if __name__ == '__main__':
    ...
    if init_from == 'scratch':
        model_args = dict(
            n_layers=2,          # Keep at 2 for now
            n_dense_layers=2,    # Keep equal to n_layers
            n_heads=4,           # Keep at 4
            ...
            qk_nope_head_dim=16, # Reduce further
            qk_rope_head_dim=16, # Reduce further
            v_head_dim=16,      # Reduce further
            original_seq_len=4096,
            rope_theta=10000.0,
            rope_factor=1.0,
            beta_fast=32,
            beta_slow=1,
            mscale=1.0,
            dim=160,            # Further reduced dimension.
            inter_dim=640,    # 4 * dim
            moe_inter_dim=640,  # Match inter_dim
